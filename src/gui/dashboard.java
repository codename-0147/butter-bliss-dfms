...
//private profile profile;
    ...
    private void updateCountsDisplay(int ordercount, int outletcount, int employeecount, int deliverdItems, int SpecialOrders,int totalSales) {
        ...
        jButton12.setText("<html><div style='text-align: center;'><span style='font-size:13px;'><b>Total Suppliers </span>"
    ...
    private void initComponents() {
        ...
        jButton16.setFont(new java.awt.Font("Segoe UI Variable", 1, 18)); // NOI18N
        ...
        jPanel1.add(jButton16, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 150, 410, 46));

        jButton4.setBackground(new java.awt.Color(243, 185, 126));
        jButton4.setFont(new java.awt.Font("Segoe UI Variable", 1, 18)); // NOI18N
        jButton4.setForeground(new java.awt.Color(121, 71, 21));
        ...
        jPanel1.add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 240, 410, 46));
