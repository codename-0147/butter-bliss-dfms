 ...
 * @author chath
 */
public class PendingOrders extends javax.swing.JDialog {
     ...
     */
    public PendingOrders(java.awt.Frame parent, boolean modal, DashboardOU dashboard) {
        super(parent, modal);
    ...
    private void loadPendingOrders() {
        try {
            ...
            while (resultSet.next()) {
                ...
                vector.add(resultSet.getString("order_id"));        // Order ID
                vector.add(resultSet.getString("order_type"));      // Order Type
                vector.add(resultSet.getString("order_date"));      // Order Date
                vector.add(resultSet.getString("w_product_id"));      // Product ID
                vector.add(resultSet.getString("w_product_name"));    // Product Name
                vector.add(resultSet.getString("order_qty"));       // Quantity
                model.addRow(vector);
            }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Order ID", "Type", "Date", "Product Id", "Product Name", "Quantity"
            }
        ) {
