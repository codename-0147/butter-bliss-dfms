...
private boolean isSameDay(Date date1, Date date2) {
  ...
  + "INNER JOIN `distributor` ON `delivery`.`distributor_id` = `distributor`.`id`"
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(930, 10, 40, 40));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 60, 960, 250));

        jButton2.setBackground(new java.awt.Color(255, 248, 244));
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/icons8-refresh-30.png"))); // NOI18N
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(880, 10, 40, 40));

        jPanel2.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 250, 1010, 340));

        jPanel4.setBackground(new java.awt.Color(231, 218, 194));
        jPanel4.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jButton3.setBackground(new java.awt.Color(255, 255, 235));
        ...
        jPanel4.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 40, 220, 100));
        ...
        jPanel4.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 0, -1, -1));
        jPanel4.add(jCalendar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 40, 190, 140));

        jButton4.setBackground(new java.awt.Color(255, 231, 208));
        ...
        jPanel4.add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 40, 240, 100));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/12aa.jpg"))); // NOI18N
        jPanel4.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -10, 230, 200));

        jPanel2.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 50, 1010, 190));
