...
public class DashboardOU extends javax.swing.JPanel {
    ...
    private void setTodaySales() {
        ...
        try {
            ...
            String query = "SELECT SUM(customer_invoice_items.qty * stock.price) AS total_amount "
                    ...
                    + "WHERE customer_invoice.date = '" + todayDateString + "'";
            ...
            if (resultSet.next()) {
                ...
                String buttonText = "<html><div style='text-align:left; padding-left:10px;'>"
                        + "Today Sales<br>"
                        + "<div style='font-size:16px; text-align:left; padding-left:10px;'>Rs. " + String.format("%.2f", totalAmount) + "</div></div></html>";
                jButton12.setText(buttonText); // You can assign this to any JButton, replace jButton11 with yours
            } else {
                jButton12.setText("<html><div style='text-align:left; padding-left:10px;'>"
                        + "Today Sales<br><span style='font-size:16px; text-align:left; padding-left:10px;'>Rs. 0.00</span></div></html>");
            }
    ...
    private void setTopProducts() {
        ...
        try {
            java.sql.Date todayDate = new java.sql.Date(System.currentTimeMillis());
            String todayDateString = todayDate.toString();
            String yearMonth = todayDateString.substring(0, 7); // "YYYY-MM"

            // Query for Today's Top Product
            String queryToday = "SELECT product.name, SUM(customer_invoice_items.qty) AS total_qty "
                    + "FROM customer_invoice "
                    + "INNER JOIN customer_invoice_items ON customer_invoice.id = customer_invoice_items.customer_invoice_id "
                    + "INNER JOIN stock ON customer_invoice_items.stock_id = stock.id "
                    + "INNER JOIN product ON stock.product_id = product.id "
            ...
            // Query for Monthly Best Seller
            String queryMonth = "SELECT product.name, SUM(customer_invoice_items.qty) AS total_qty "
                    + "FROM customer_invoice "
                    + "INNER JOIN customer_invoice_items ON customer_invoice.id = customer_invoice_items.customer_invoice_id "
                    + "INNER JOIN stock ON customer_invoice_items.stock_id = stock.id "
                    + "INNER JOIN product ON stock.product_id = product.id "
                    + "WHERE customer_invoice.date LIKE '" + yearMonth + "%' "
                    + "GROUP BY product.id "
                    + "ORDER BY total_qty DESC "
                    + "LIMIT 1";

            String todayText = "None";
            String monthText = "None";

            ResultSet rsToday = MySQL.executeSearch(queryToday);
            if (rsToday.next()) {
                todayText = rsToday.getString("name") + " (" + rsToday.getInt("total_qty") + ")";
            }

            ResultSet rsMonth = MySQL.executeSearch(queryMonth);
            if (rsMonth.next()) {
                monthText = rsMonth.getString("name") + " (" + rsMonth.getInt("total_qty") + ")";
            }

            String buttonText = "<html><div style='text-align:left; padding-left:10px;'>"
                    + "Today's Top Product<br>"
                    + "<div style='font-size:12px; padding-left:10px;'>" + todayText + "</div>"
                    + "<br>"
                    + "Monthly Best Seller<br>"
                    + "<div style='font-size:12px; padding-left:10px;'>" + monthText + "</div>"
                    + "</div></html>";

            jButton15.setText(buttonText); // Set to your single button
    ...
    private void showTodaySalesPieChart() {
        try {
            ...
            JFreeChart chart = ChartFactory.createPieChart(
                    "Today's Sales by Product", dataset, true, true, false
            );
    ...
    private void initComponents() {
        ...
        jButton10.setIconTextGap(130);
        jButton10.setMargin(new java.awt.Insets(2, 14, 30, 14));
        jButton10.setMaximumSize(new java.awt.Dimension(298, 74));
        jButton10.setMinimumSize(new java.awt.Dimension(298, 74));
        jButton10.setPreferredSize(new java.awt.Dimension(298, 74));
        jButton10.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton10ActionPerformed(evt);
            }
        });
        add(jButton10, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 50, 350, 100));
        ...
        jButton11.setIconTextGap(130);
        jButton11.setMargin(new java.awt.Insets(2, 14, 30, 14));
        jButton11.setMaximumSize(new java.awt.Dimension(298, 74));
        jButton11.setMinimumSize(new java.awt.Dimension(298, 74));
        jButton11.setPreferredSize(new java.awt.Dimension(298, 74));
        jButton11.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton11ActionPerformed(evt);
            }
        });
        add(jButton11, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 180, 350, 90));
        ...
        jButton13.setIconTextGap(130);
        jButton13.setMargin(new java.awt.Insets(2, 14, 30, 14));
        jButton13.setMaximumSize(new java.awt.Dimension(298, 74));
        jButton13.setMinimumSize(new java.awt.Dimension(298, 74));
        jButton13.setPreferredSize(new java.awt.Dimension(298, 74));
        jButton13.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton13ActionPerformed(evt);
            }
        });
        add(jButton13, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 300, 350, 110));
        ...
        add(jButton12, new org.netbeans.lib.awtextra.AbsoluteConstraints(494, 50, 350, 110));
        ...
        add(jButton15, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 430, 350, 170));
        ...
        jButton16.setMargin(new java.awt.Insets(2, 14, 5, 14));
        jButton16.setVerticalAlignment(javax.swing.SwingConstants.TOP);
        add(jButton16, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 430, 347, 160));
        ...
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(900, 6, -1, -1));
        ...
        add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 160, 280, 270));
