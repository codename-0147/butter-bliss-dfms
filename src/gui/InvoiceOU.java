...
public class InvoiceOU extends javax.swing.JPanel {
    ...
    private void loadCustomerMap() {
        customerMap.clear();
        try {
            ResultSet rs = MySQL.executeSearch("SELECT `id`, `mobile` FROM `customer`");
            while (rs.next()) {
                String id = rs.getString("id");
                String mobile = rs.getString("mobile");
                customerMap.put(mobile, id);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void initComponents() {
        ...
        jButton16.setFont(new java.awt.Font("Poppins Medium", 0, 12)); // NOI18N
        ...
        balanceField.setFont(new java.awt.Font("Poppins", 1, 18)); // NOI18N
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(balanceField, javax.swing.GroupLayout.Alignment.TRAILING)
        ...
        jLabel12.setText("CUSTOMER NAME HERE");
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                        .addGroup(layout.createSequentialGroup()
                                            ...
                                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                                .addGroup(layout.createSequentialGroup()
                                                    ...
                                                    .addGap(18, 18, 18)
                                                    .addComponent(stockBarcodeField, javax.swing.GroupLayout.PREFERRED_SIZE, 153, javax.swing.GroupLayout.PREFERRED_SIZE))
                                                .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGroup(layout.createSequentialGroup()
                                            ...
                                            .addComponent(customerMobileField, javax.swing.GroupLayout.PREFERRED_SIZE, 76, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void printInvoiceButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printInvoiceButtonActionPerformed
        ...
        String customerMobile = customerMobileField.getText().trim();
        String outlet = String.valueOf(jComboBox3.getSelectedItem());
        ...
        String customerId = customerMap.get(customerMobile);
        if (customerId == null) {
        ...
        if (outletId == null) {
            JOptionPane.showMessageDialog(this, "Invalid outlet selected", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        try {
            ...
            MySQL.executeIUD("INSERT INTO `customer_invoice` VALUES ('" + invoiceID + "', '" + dateTime + "', '" + paidAmount + "', '" + discount + "', '" + customerId + "', '" + paymentMethodID + "', '" + outletId + "')");
            //insert to invoice
       
            // Insert invoice items and update stock qty
            for (InvoiceItemOU invoiceItem : invoiceItemMap.values()) {
            ...
            // Calculate points (example: 1 point per 100 units of total)
            double totalAmount = Double.parseDouble(totalField.getText());
            double points = totalAmount / 100.0;

            // Update points in customer table
            // Assuming withdawPoints and newPoints are declared and managed properly
            if (withdawPoints) {
                newPoints += points;
...
//view or print report
            ...
            params.put("Parameter3", customerMobileField.getText());
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(this, "Error printing invoice: " + e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
        }
...
//                JasperExportManager.exportReportToPdfFile(report, outputPath);
    ...
    private void jButton16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton16ActionPerformed
        ...
        String customer = customerMobileField.getText();
        ...
        } else if (outlet.equals("Select Outlet")) {
            JOptionPane.showMessageDialog(this, "Please select a outlet", "Warning", JOptionPane.WARNING_MESSAGE);
