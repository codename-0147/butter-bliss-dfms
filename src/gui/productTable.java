...
public class productTable extends javax.swing.JDialog {
   ...
   private void loadCategory (){
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 110, 240, -1));
        jPanel1.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 370, 240, 30));

        jLabel2.setFont(new java.awt.Font("Segoe UI Semibold", 1, 14)); // NOI18N
        jLabel2.setText("Category");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 260, 240, -1));
        ...
        jPanel1.add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 290, 240, 30));
        ...
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 190, 240, -1));
        ...
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 340, 250, -1));
        jPanel1.add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 140, 240, 30));

        jLabel6.setBackground(new java.awt.Color(245, 219, 200));
        jLabel6.setForeground(new java.awt.Color(245, 219, 200));
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 60, -1, -1));
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        if (evt.getClickCount() == 2) {
            ...
            if (selectedRow != -1) {
                ...
                jLabel6.setText(String.valueOf(jTable1.getValueAt(selectedRow, 0)));
        ...
        try {
            ...
            if (pname.isEmpty()) {
                ...
                if (resultSet.next()) {
                    ...
                    MySQL.executeIUD("INSERT INTO `product`(`name`,`price`,`weight`,`category_id`)"
